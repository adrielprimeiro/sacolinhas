...
class AvaliacaoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'items.*.estado' => 'required|string|in:Novo,Seminovo,Usado',
            'items.*.nota_curadoria' => 'required|integer|min:1|max:10',
            'items.*.motivo_curadoria' => 'nullable|string|max:100',
        ...
        try {
            ...
            foreach ($itemsData as $itemData) {
                ...
                $avItem = new AvaliacaoItem([
                    ...
                    'motivo_curadoria' => $itemData['motivo_curadoria'] ?? null,
                ...
                // e o preco_venda é calculado multiplicando pelo Markup (2.0231) se não estiver definido
    ...
    public function finalize(Request $request, Avaliacao $avaliacao)
    {
        ...
        try {
            ...
            foreach ($items as $item) {
                ...
                if ($avaliacao->tipo_compra === 'direta') {
                    if (is_null($item->preco_venda) || $item->preco_venda < 0) {
