            ...
            <div>
                ...
                <div class="relative">
                    <textarea 
                        ...
                        rows="3" 
                        required
                        class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all text-gray-800 resize-none"
                    ...
                    <button 
                        ...
                        class="absolute right-3 bottom-4 w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 transition-colors"
                ...
                <p class="mt-2 text-xs text-gray-500 italic">
                    ...
                    Pode falar ou digitar: inclua tamanho, cor, estilo ou faixa de preço. Cuidamos do resto.
                </p>
            </div>
                ...
                @foreach($wishes as $wish)
                    <div class="border border-gray-100 rounded-xl p-4 flex flex-col sm:flex-row gap-4 items-start sm:items-center hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex flex-row items-center gap-4">
                            ...
                            <button 
                                type="button" 
                                onclick="excluirCuradoria({{ $wish->id }})"
...
<script>
    ...
    // Lógica para Exclusão de Desejo
    async function excluirCuradoria(id) {
        if(!confirm('Tem certeza que deseja cancelar esta curadoria?')) return;
    ...
    // Lógica para Gravação de Áudio (Web Speech API)
    let recognition;
    ...
    function toggleDictation() {
        ...
        if (!('webkitSpeechRecognition' in window) && !('SpeechRecognition' in window)) {
            alert('O seu navegador não suporta ditado por voz. Tente atualizar ou usar o Google Chrome.');
            return;
        }
        ...
        function stopDictationUI() {
            ...
            btn.classList.replace('text-red-600', 'text-gray-500');
            icon.classList.remove('animate-pulse');
            input.placeholder = "Ex: Quero um vestido midi floral tamanho M, até R$ 90, para usar no fim de semana...";
        }
    }
</script>
@endsection
