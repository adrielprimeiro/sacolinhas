...
<head>
    ...
    <title>Endereçamento (Alocação)</title>
...
<div id="setup-screen">
    ...
    <div class="setup-header">
        <a href="{{ route('items.index') }}" title="Voltar ao Inventário"><i class="fas fa-arrow-left"></i></a>
        <h1>Endereçamento <span>(Alocação)</span></h1>
    </div>
    ...
    {{-- Hidden form --}}
    <form id="form-processar" method="POST" action="{{ route('alocacao.processar') }}" style="display:none;">
        @csrf
