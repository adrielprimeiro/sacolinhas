...
<div class="flex gap-2 mb-6 border-b border-gray-200 pb-3 overflow-x-auto">
    ...
    <a href="{{ route('financeiro.lancamentos.index') }}" class="px-4 py-2 rounded-t text-sm font-semibold bg-indigo-600 text-white whitespace-nowrap"><i class="fas fa-file-invoice-dollar mr-1"></i> Lançamentos</a>
