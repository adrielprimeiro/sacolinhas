...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
        ...
        <div class="p-8">
            <form action="{{ route('admin.conta_corrente.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" 
                            class="px-8 py-2.5 bg-blue-100 hover:bg-blue-200 text-blue-900 border border-blue-200 rounded-xl text-sm font-bold shadow-sm transition transform active:scale-95">
                        Salvar Lançamento
                    </button>
                </div>
            </form>
