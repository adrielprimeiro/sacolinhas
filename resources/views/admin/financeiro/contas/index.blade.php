...
<div class="flex gap-2 mb-6 border-b border-gray-200 pb-3 overflow-x-auto">
    <a href="{{ route('financeiro.dashboard') }}" class="px-4 py-2 rounded-t text-sm font-semibold text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition whitespace-nowrap"><i class="fas fa-home mr-1"></i> Dashboard</a>
    <a href="{{ route('financeiro.lancamentos.index') }}" class="px-4 py-2 rounded-t text-sm font-semibold text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition whitespace-nowrap"><i class="fas fa-file-invoice-dollar mr-1"></i> Lançamentos</a>
    <a href="{{ route('financeiro.contas.index') }}" class="px-4 py-2 rounded-t text-sm font-semibold bg-indigo-600 text-white whitespace-nowrap"><i class="fas fa-university mr-1"></i> Contas</a>
    ...
    <a href="{{ route('financeiro.conciliacao.index') }}" class="px-4 py-2 rounded-t text-sm font-semibold text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition whitespace-nowrap"><i class="fas fa-balance-scale mr-1"></i> Conciliação</a>
